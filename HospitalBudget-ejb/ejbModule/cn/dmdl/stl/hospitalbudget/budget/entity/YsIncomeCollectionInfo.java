...
/**
 * YsIncomeCollectionInfo generated by hbm2java
 */
@Entity
...
public class YsIncomeCollectionInfo implements java.io.Serializable {
	...
	public YsIncomeCollectionInfo() {
	}

	public YsIncomeCollectionInfo(int budgetCollectionDeptId, String year,
	...
	@Column(name = "income_collection_info_id", unique = true, nullable = false)
	public Integer getIncomeCollectionInfoId() {
		return this.incomeCollectionInfoId;
	}

	public void setIncomeCollectionInfoId(Integer incomeCollectionInfoId) {
		this.incomeCollectionInfoId = incomeCollectionInfoId;
	}
