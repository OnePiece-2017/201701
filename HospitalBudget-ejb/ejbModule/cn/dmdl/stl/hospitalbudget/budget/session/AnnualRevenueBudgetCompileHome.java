...
@Name("annualRevenueBudgetCompileHome")
public class AnnualRevenueBudgetCompileHome extends CriterionEntityHome<Object> {
	...
	public JSONArray getCandidateProject() {
		...
		String dataSql = "select the_id, the_type, the_state, the_value, multilevel, total_amount, department_info_id from ys_convention_project where deleted = 0 and the_type = 1";// 收入预算
