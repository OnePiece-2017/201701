...
public class MD5 {
	...
	/*
	 * 下面这些S11-S44实际上是一个4*4的矩阵，在原始的C实现中是用#define实现的， 这里把它们实现成为static final是表示了只读，切能在同一个进程空间内的多个 Instance间共享
	 */
	...
	public static String getMD5Alpha(Object object) {
		if (object != null) {
			MD5 md5 = new MD5();
			return md5.getMD5ofStr(md5.getMD5ofStr(object.toString())).toLowerCase();
		}
		return null;
	}
	...
	public static void main(String args[]) {
		System.out.println(MD5.getMD5Alpha(null));
		System.out.println(MD5.getMD5Alpha(""));
		System.out.println(MD5.getMD5Alpha("."));
		System.out.println(MD5.getMD5Alpha("1234567890"));
		System.out.println(MD5.getMD5Alpha(123));
		System.out.println(MD5.getMD5Alpha("123"));
		System.out.println(MD5.getMD5Alpha("binary"));
	}
}
